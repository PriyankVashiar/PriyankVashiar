...
<body>
    <header>
        <a href="" class="brand" data-aos="zoom-in" data-aos-duration="1000">Priyank Vashiar</a>
    ...
    <section class="main" id="main">
        <div class="content">
            <h2 data-aos="fade-right" data-aos-duration="1000" data-aos-delay="800">Hello, I'm <br><span>Priyank Vashiar</span></h2>
        ...
        <div class="content">
            <div class="column col-left reveal">
                <div class="img-card" data-aos="fade-right" data-aos-duration="2000" data-aos-delay="200">
                    <img src="Image/ProfilePic.jpg" alt="Profile Picture of Priyank Vashiar">
                </div>
            </div>
            <div class="column col-right reveal">
                <h2 class="content-title" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">Hey There! I am Priyank Vashiar</h2>
                <p class="paragraph-text" data-aos="flip-up" data-aos-duration="1000" data-aos-delay="400">I'm a free spirited person who is just looking for the next challenge. I completed my schooling from Air Force School Jamnagar and tried for the defense forces in India. Didn't work out as expected and went on to pursue my interest in programming. Completed my B. Tech in Information Technology from BVM Anand. Worked for 2+ years at Zeus Learning as a Software Engineer with primary task as website development. Decided to take up MBA in Finance at NMIMS Mumbai and currently enjoying the journey that is life.</p>
    ...
    <section class="skills" id="skills">
        ...
        <div class="content">
            <div class="column col-left">
                ...
                <div class="paragraph-text" data-aos="flip-down" data-aos-duration="1000" data-aos-delay="300">Have a plethora of experience starting from equity research and analysis. Also have experience in valuation as I've during my MBA itself valued multiple companies such as HDFC Bank, Federal Bank through the easiest Discounted Cash Flow (DCF) method. Also did a detailed valuation of MRF Tyres as well as Apollo Tyres using DCF as well as relative valuation according to multiples. Have prior experience of working with ReactJS, AngularJS, DotNet, SQL during my work at Zeus Learning. Also have good understanding of OOPS concepts as well as various programming languages during my B.Tech.</div>
...
<!-- Work Section -->
    ...
    <section class="contact" id="contact">
      ...
      <footer class="footer">
        <span class="footer-title">Priyank Vashiar</span>
      </footer>
